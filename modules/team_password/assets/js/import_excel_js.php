<script>
   ...
   (function($) {
    ...
    "use strict";
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/team_password/uploads/file_sample/Sample_import_password_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );

      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/team_password/uploads/file_sample/Sample_import_password_file_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
...
function uploadfilecsv(){
  "use strict";
    ...
    formData.append("cate", "<?php echo $cate; ?>")

    $.ajax({ 
      url: admin_url + 'team_password/import_file_xlsx_password', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
