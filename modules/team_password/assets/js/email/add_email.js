(function(){
  ...
  $('body').on('click','.view_password',function(e){
    ...
    $('body').on('click','.view_smtp_password',function(e){
        e.preventDefault();
        var has = $(this).find('i').hasClass('fa-eye');
        if(has){
          $(this).find('i').removeClass('fa-eye');
          $(this).find('i').addClass('fa-eye-slash');
          $('input[name="smtp_password"]').attr('type', 'text');
        }
        else{
          $(this).find('i').removeClass('fa-eye-slash');
          $(this).find('i').addClass('fa-eye');
          $('input[name="smtp_password"]').attr('type', 'password');
        }
    });
  ...
  function RandomNumber(string_length,chars) {
     ...
     */
     function generate_password(){
      'use strict';
        var length = $('#length_password').val();       
        $('input[name="password"]').val(create_password(length));
     }

     /**
     * generate smtp_password
     */
     function generate_smtp_password(){
      'use strict';
        var length = $('#length_smtp_password').val();       
        $('input[name="smtp_password"]').val(create_password(length));
     }
   ...
   function create_password(length){
    'use strict';
     var password = '';
        ...
        return shuffle(shuffle(password));
   }
