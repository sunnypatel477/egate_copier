          ...
          <div class="horizontal-tabs mb-4">
            <ul class="nav nav-tabs nav-tabs-horizontal">
               <li <?php if($type == 'all_password'){ echo 'class="active"'; } ?> >
                <a href="<?php echo admin_url('team_password/team_password_mgt?cate='.$cate.'&type=all_password'); ?>" data-group="profile">
               ...
               <?php if(has_permission('team_password','','view') || is_admin()){ ?>
                <li class="<?php if($type == 'permission'){ echo 'active'; } ?>" >
                  ...
                  <li class="<?php if($type == 'import'){ echo 'active'; } ?>" >
                    <a href="<?php echo admin_url('team_password/team_password_mgt?cate='.$cate.'&type=import'); ?>" data-group="import">
                      <i class="fa fa-download menu-icon"></i><?php echo _l('import'); ?></a>
                  </li>
                <?php } ?>
                </ul>
              </div>
...
<?php if($type == 'import'){  
  require 'modules/team_password/assets/js/import_excel_js.php';
}
?>