 ...
 <div class="content">
   <div class="panel_s">
    <div class="panel-body">
     ...
     <div class="clearfix"></div>
     <?php echo form_open(site_url('team_password/team_password_client/add_server'),array('id'=>'form_category_management')); ?>	            
     ...
     <div class="col-md-12">
      <div class="form-group">
       ...
       <div class="input-group">
        ...
        <input type="password" class="form-control" name="password" value="<?php echo html_entity_decode('password', $password); ?>">
