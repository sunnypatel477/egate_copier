...
class Knowledge extends ClientsController
{
    ...
    public function index($slug = '')
    {
        ...
        $this->view('client/knowledge_base');
        $this->data($data);
        $this->layout();
    }
    public function download_files($attachment_key){
    ...
    public function article($slug)
    {
        ...
        $this->view('client/knowledge_base_article');
        $this->data($data);
        $this->layout();
    }
