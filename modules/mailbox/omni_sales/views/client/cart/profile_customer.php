  ...
  <div class="fr1">
    ...
    <tbody>
      ...
      if($list_id){
        ...
        $trade_discounts = $this->omni_sales_model->get_discount_list(2, get_client_user_id());
        ?>
          ...
          <tr class="main">
            ...
            <td align="right" class="middle">
              <strong>
                ...
                if($tax_data){
                  ...
                  //OLD CODE $tax_value = (((int)$array_list_qty[$key]*$prices) * $data_tax)/100;
                  $tax_value = (((int)$array_list_qty[$key]*$price_af_dc) * $data_tax)/100;
            ...
            <td align="right" class="middle">
             <strong class="line_total_<?php echo html_entity_decode($key); ?>">
               ...
               $line_total_af_dc = (int)$array_list_qty[$key]*$price_af_dc;
               echo app_format_money($line_total,'');

               // OLD CODE $tax = ($line_total * $data_tax)/100;
               $tax = ($line_total_af_dc * $data_tax)/100;
               $price_tax += $tax;
...
<?php
$shipping_fee = get_option('omni_portal_shipping_fee');
$shipping_form = get_option('omni_pos_shipping_fee_form');
$shipping_value = get_option('omni_portal_shipping_fee');
...
if(get_option('omni_sale_hide_shipping_fee') == 1){
  $shipping_fee = 0;
}
