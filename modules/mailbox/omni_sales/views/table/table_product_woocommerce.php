...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [db_prefix() . 'woocommere_store_detailt.product_id', db_prefix() . 'items.sku_code', 'woocommere_store_id', db_prefix() . 'items.commodity_code', db_prefix() . 'items.description', db_prefix() . 'items.rate']);
