    ...
    <div class="panel_s">
        <div class="panel-body">
            <h4 class="tw-my-0 tw-font-semibold">
                <?php echo _l('schedule_email_for', format_purchase_order_number($purchase_order->id)); ?>
            </h4>
            <hr class="hr-panel-separator" />
            <div class="row">
                <div class="col-md-12">
                    <div class="checkbox checkbox-primary">
                        <input type="checkbox" name="attach_pdf" id="attach_pdf" <?php echo (isset($schedule) && $schedule->attach_pdf || !isset($schedule) ? ' checked' : ''); ?>>
        ...
        <div class="panel-footer text-right">
            <a href="#" class="btn btn-danger" onclick="init_purchase_order(<?php echo $purchase_order->id; ?>); return false;">
                <?php echo _l('cancel'); ?>
            </a>
            <button type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" data-form="#schedule_send_form" class="btn btn-success">
