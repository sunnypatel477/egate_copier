                ...
                <?php if (count($invoice->payments) > 0) { ?>
                    ...
                    <?php foreach ($invoice->payments as $attachment) { ?>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab_files">
                            ...
                            <div class="col-md-12">
                                <?php
                                $invoicetmpDir = module_dir_url('invoice_payment_attachment/asset/invoice_hard_copy');
                            ...
                            <div class="col-md-12">
                                <?php
                                $paymentproftmpDir = module_dir_url('invoice_payment_attachment/asset/payment_prof');
                            ...
                            <div class="col-md-12">
                                <?php
                                $officialreceipttmpDir = module_dir_url('invoice_payment_attachment/asset/officialreceipt');
                            ...
                            <div class="col-md-12">
                                <?php
                                $taxdeduction2307tmpDir = module_dir_url('invoice_payment_attachment/asset/taxdeduction2307');
