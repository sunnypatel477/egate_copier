            ...
            <div class="horizontal-tabs">
                <ul class="nav nav-tabs customer-profile-tabs nav-tabs-horizontal" role="tablist">
                    ...
                    <?php if(isset($client->userid)) {?>
                        <?php 
                            $CI = &get_instance(); 
                            $leads = $CI->db->where('existing_client_id', $client->userid)->where('status !=', CLOSED_WON)->where('status !=', CLOSED_LOST)->get(db_prefix() . 'leads')
                            ->result_array();
                            $num_leads = count($leads);
                            ?>

                       <li role="presentation">
                        <a href="#lead" aria-controls="lead" role="tab" data-toggle="tab">
                            <?php echo _l('lead'); ?>
                            <span class="lead-count"><?php echo $num_leads; ?></span>
                        </a>
                    </li>
                    <?php } ?>
                    <li role="presentation">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <a href="<?php echo maybe_add_http($client->website); ?>" class="btn btn-default" target="_blank" tabindex="-1">
                        ...
                        <div class="row">
                            <div class="col-md-<?php echo !is_language_disabled() ? 6 : 12; ?>">
                                <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="<?php echo _l('customer_currency_change_notice'); ?>"></i>
                                <?php
                        ...
                        <tbody>
                            <?php foreach ($customer_admins as $c_admin) { ?>
                                <tr>
                                    ...
                                    <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
                                        <td>
                                            <a href="<?php echo admin_url('clients/delete_customer_admin/' . $client->userid . '/' . $c_admin['staff_id']); ?>" class="tw-mt-px tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700 _delete">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="tw-font-medium tw-text-base tw-text-neutral-700 tw-flex tw-justify-between tw-items-center tw-mt-0 tw-mb-6">
                                    <?php echo _l('lead_inquiry_about'); ?>
                                </h4>
                            </div>
                            <div class="col-md-12">
                                <?php
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h4 class="tw-font-medium tw-text-base tw-text-neutral-700 tw-flex tw-justify-between tw-items-center tw-mt-0 tw-mb-6">
                                    <span>
                                        <i class="fa-regular fa-circle-question tw-mr-1" data-toggle="tooltip" data-title="<?php echo _l('customer_shipping_address_notice'); ?>"></i>
...
<script>
    $(function(){
        var tAPI = initDataTable('.table-leads-client', admin_url + 'client_lead/leads/lead_table/<?php echo $client->userid;?>', [0], [0], {},
           '');
    });
</script>
