...
<?php echo form_open_multipart(admin_url('client_lead/leads/record_payment'), ['id' => 'record_payment_form']); ?>
                ...
                <div class="col-md-6">
                    ...
                    ?>
                        <div class="alert alert-info">
                            ...
                            Click <a href="<?php echo admin_url('invoices/invoice/' . $invoice->id . '?allowed_payment_modes=1'); ?>">here</a>
                ...
                <div class="col-md-12 tw-mt-3">
                    ...
                    if ($pr_template || $sms_trigger) { ?>
                        <div class="checkbox checkbox-primary mtop15">
                            <input type="checkbox" name="do_not_send_email_template" id="do_not_send_email_template" checked>
