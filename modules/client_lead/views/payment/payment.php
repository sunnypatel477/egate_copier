                ...
                <div class="col-md-12 no-padding">
                    <div class="panel_s">
                        <div class="panel-body">
                            <?php echo form_open_multipart($this->uri->uri_string(), ['id' => 'payment_form']) ; ?>
                            ...
                            <?php echo render_textarea('note', 'note', $payment->note, ['rows' => 7]); ?>
                                ...
                                <h4 class="col-md-12 tw-mt-3 tw-font-semibold"><?php echo _l('attachment'); ?></h4>
                                <div class="file-section-container">
                                    <div class="row">
                                    <div class="col-md-6">
                                        <label for="invoice_hard_copy" class="control-label"><?php echo _l('invoice_hard_copy'); ?></label>
                                        <input type="file" name="invoice_hard_copy" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="payment_prof" class="control-label"><?php echo _l('payment_prof'); ?></label>
                                        <input type="file" name="payment_prof" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="official_receipt" class="control-label"><?php echo _l('official_receipt'); ?></label>
                                        <input type="file" name="official_receipt" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tax_deduction_2307" class="control-label"><?php echo _l('tax_deduction_2307'); ?></label>
                                        <input type="file" name="tax_deduction_2307" class="form-control">
                                    </div>
                                    </div>
                                </div>
                            ...
                            <table class="table">
                                <tbody>
                                    <?php if ($payment->invoice_hard_copy != '') { ?>
                                        <tr>
                                            <td><?php echo _l('invoice_hard_copy'); ?></td>
                                            <td>
                                                <?php
                                                $invoicetmpDir = module_dir_url('client_lead/asset/invoice_hard_copy');
                                                $invoice_hard_copy = $invoicetmpDir . $payment->invoice_hard_copy;
                                                ?>
                                                <a href="<?php echo $invoice_hard_copy; ?>" target="_blank"><?php echo $payment->invoice_hard_copy; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($payment->payment_prof != '') { ?>
                                        <tr>
                                            <td><?php echo _l('payment_prof'); ?></td>
                                            <td>
                                                <?php
                                                $paymentproftmpDir = module_dir_url('client_lead/asset/payment_prof');
                                                $payment_prof = $paymentproftmpDir . $payment->payment_prof;
                                                ?>
                                                <a href="<?php echo $payment_prof; ?>" target="_blank"><?php echo $payment->payment_prof; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($payment->officialreceipt != '') { ?>
                                        <tr>
                                            <td><?php echo _l('official_receipt'); ?></td>
                                            <td>
                                                <?php
                                                $officialreceipttmpDir = module_dir_url('client_lead/asset/officialreceipt');
                                                $official_receipt = $officialreceipttmpDir . $payment->officialreceipt;
                                                ?>
                                                <a href="<?php echo $official_receipt; ?>" target="_blank"><?php echo $payment->officialreceipt; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($payment->taxdeduction2307 != '') { ?>
                                        <tr>
                                            <td><?php echo _l('tax_deduction_2307'); ?></td>
                                            <td>
                                                <?php
                                                $taxdeduction2307tmpDir = module_dir_url('client_lead/asset/taxdeduction2307');
                                                $tax_deduction_2307 = $taxdeduction2307tmpDir . $payment->taxdeduction2307;
                                                ?>
                                                <a href="<?php echo $tax_deduction_2307; ?>" target="_blank"><?php echo $payment->taxdeduction2307; ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
