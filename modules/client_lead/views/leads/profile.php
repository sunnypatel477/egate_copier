...
<div class="<?php if ($openEdit == true) {
    ...
    <?php if (isset($lead)) { ?>
        ...
        <div class="mleft5 pull-right<?php echo $lead_locked == true ? ' hide' : ''; ?>">
            <a href="#" lead-edit data-toggle="tooltip" data-title="<?php echo _l('edit'); ?>" class="btn btn-default lead-top-btn">
        ...
        <?php if ($lead_locked == false) { ?>
            <div class="lead-edit<?php if (isset($lead)) {
                ...
                <button type="button" class="btn btn-primary pull-right lead-top-btn lead-save-btn" onclick="document.getElementById('lead-form-submit').click();">
                    <?php echo _l('submit'); ?>
                </button>
            </div>
        <?php } ?>
    ...
    <?php } ?>
    <?php echo form_open((isset($lead) ? admin_url('leads/lead/' . $lead->id) : admin_url('leads/lead')), ['id' => 'lead_client_form']); ?>
    <div class="row">
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <div class="col-md-6">
                ...
                echo render_select('existing_client_id', $customer, ['userid', 'company'], 'existing_client_id', $selected); ?>
            </div>
            <div class="col-md-12">
...
function lead_profile_form_handler(form) {
  ...
  $.post(form.attr("action"), data)
    .done(function (response) {
      ...
      if ($.fn.DataTable.isDataTable(".table-client-leads")) {
        tAPI.DataTable().ajax.reload(null, false);
