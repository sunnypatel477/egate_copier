...
<div class="modal-body">
    ...
    echo ' lead-new';
                        ...
                        ?>
                           ...
                           $count_reminder_id = get_note_by_lead_reminder($lead->id);
                           if ($count_reminder_id->totalnote > 0) {
                               echo ' <span class="badge">' . $count_reminder_id->totalnote . '</span>';
                           }
                           ?>
                                </a>
                            </li>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab_lead_profile">
                    <?php $this->load->view('leads/profile'); ?>
                </div>
                <?php if (isset($lead)) { ?>
                <?php if (count($mail_activity) > 0 || isset($show_email_activity) && $show_email_activity) { ?>
                ...
                <div role="tabpanel" class="tab-pane" id="attachments">
                    ...
                    <div class="mtop20" id="lead_attachments">
                        <?php $this->load->view('leads/leads_attachments_template', ['attachments' => $lead->attachments]); ?>
                    </div>
                    <?php } ?>
                </div>
