        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <a href="<?php echo admin_url('client_lead/leads/import'); ?>"
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            ...
                            <a href="<?php echo admin_url('client_lead/leads/switch_kanban/' . $switch_kanban); ?>"
                    ...
                    <div class="<?php echo $isKanBan ? '' : 'panel-body' ; ?>">
                        ...
                        if ($isKanBan) { ?>
                            ...
                            <div class="row" id="leads-table">
                                ...
                                <div class="col-md-12">
                                    <a href="#" data-toggle="modal" data-table=".table-client-leads"
...
$(function() {
    // var tAPI = initDataTable('.table-client-leads', admin_url + 'client_lead/leads/table', [0], [0], {},{});
