            ...
            <div class="panel_s">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        // if ($main_page) {
                        //     $table_data[] = _l('hr_hr_staff_name');
                        // }
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form">
                                        ...
                                        <input type="hidden" name="page" id="page" value="true" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <a href="" id="image_download_anc" target="_blank">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    initDataTable('.table-table_issued_assets_bnefits', admin_url + "hr_profile/table_issued_assets_bnefits", [1], [1]);
