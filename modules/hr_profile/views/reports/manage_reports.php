            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                    ...
                    <hr class="hr-10" />
                    <p><a href="#" class="font-medium" onclick="init_report(this,'list_of_discipline_report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('list_of_discipline_report'); ?></a></p>

                    <hr class="hr-10" />
                    <p><a href="#" class="font-medium" onclick="init_report(this,'list_of_employee_contract_report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('list_of_employee_contract_report'); ?></a></p>
               ...
               <div class="row d-flex justify-content-center">
                    ...
                    <div class="form-group">
                       ...
                       <select name="position[]" class="selectpicker" data-live-search="true" multiple data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
                          <?php foreach($position as $status){ ?>
                             <option value="<?php echo new_html_entity_decode($status['position_id']); ?>"><?php echo new_html_entity_decode($status['position_name']) ?></option>
                          <?php } ?>
                       </select>
                    </div>
                 </div>
                ...
                <div class="row sorting_table_filter hide">
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="staff_filter"><?php echo _l('staff'); ?></label>
                        <select name="staff_filter[]" class="selectpicker" data-live-search="true" multiple data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
                           <?php foreach($staff as $item){ ?>
                              <option value="<?php echo new_html_entity_decode($item['staffid']); ?>"><?php echo new_html_entity_decode($item['firstname'].' '.$item['lastname']); ?></option>
                           <?php } ?>
                        </select>
                ...
                <div class="row sorting_table_contract_code hide">
                        <div class="form-group">
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label for="staff_filter_new"><?php echo _l('staff'); ?></label>
                                 <select name="staff_filter_new[]" class="selectpicker" data-live-search="true" multiple data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
                                    <?php foreach ($staff as $item) { ?>
                                       <option value="<?php echo new_html_entity_decode($item['staffid']); ?>"><?php echo new_html_entity_decode($item['firstname'] . ' ' . $item['lastname']); ?></option>
                                    <?php } ?>
                                 </select>
                           ...
                           <div class="col-md-4">
                              <label for="contract_code"><?php echo _l('contract_code'); ?></label>
                              <select name="contract_code[]" class="selectpicker" data-live-search="true" multiple data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
                                 <?php foreach ($contract_code as $item) { ?>
                                    <option value="<?php echo new_html_entity_decode($item['id_contract']); ?>"><?php echo new_html_entity_decode($item['contract_code']); ?></option>
                                 <?php } ?>
                              </select>
                           </div>
                        </div>
                ...
                <?php $this->load->view('reports/list_of_discipline_report.php'); ?> 
                <?php $this->load->view('reports/list_of_employee_contract_report.php'); ?> 
