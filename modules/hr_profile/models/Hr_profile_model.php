...
class Hr_profile_model extends App_Model
{
	...
	public function contract_type_chart()
	{
		...
		$color_data = [
			'#00FF7F', '#0cffe95c', '#80da22', '#f37b15', '#da1818', '#176cea', '#5be4f0', '#57c4d8', '#a4d17a', '#225b8', '#be608b', '#96b00c', '#088baf',
	...
	public function staff_chart_by_departments()
	{
		$chart = [];
		$color_data = [
			'#a48a9e', '#c6e1e8', '#648177', '#0d5ac1', '#00FF7F', '#0cffe95c', '#80da22', '#f37b15', '#da1818', '#176cea', '#5be4f0', '#57c4d8', '#a4d17a', '#225b8', '#be608b', '#96b00c', '#088baf',
	...
	public function staff_chart_by_job_positions()
	{
		$chart = [];
		$color_data = [
			'#d2737d', '#c0a43c', '#f2510e', '#651be6', '#79806e', '#61da5e', '#cd2f00', '#00FF7F', '#0cffe95c', '#80da22', '#f37b15', '#da1818', '#176cea', '#5be4f0', '#57c4d8', '#a4d17a', '#225b8', '#be608b', '#96b00c', '#088baf',
			'#63b598', '#ce7d78', '#ea9e70', '#a48a9e', '#c6e1e8', '#648177', '#0d5ac1'
		];
	...
	/**
	 * get disciplinary template
	 * @param  boolean $id 
	 * @return [type]      
	 */
	public function get_disciplinary_template($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_template')->row();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'hr_disciplinary_template')->result_array();
		}
	}
	 ...
	 * @return [type]      
	 */
	public function get_disciplinary_action($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->row();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->result_array();
		}
	}

	public function get_disciplinary_subject($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->result_array();
	...
	public function get_disciplinary_category($id = false)
	{
		if (is_numeric($id)) {
			$this->db->select('id,discipline_reason_name');
			$this->db->where('discipline_category', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->result_array();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->result_array();
	...
	/**
	 * get penalty template
	 * @param  boolean $id 
	 * @return [type]      
	 */
	public function get_penalty_template($id = false)
	{

		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_penalty_template')->row();
		}
		if ($id == '') {
			return  $this->db->get(db_prefix() . 'hr_penalty_template')->result_array();
		}
	}
	 ...
	 * @param array $data 
	 */
	public function add_disciplinary_type($data)
	{
		$result = $this->db->insert(db_prefix() . 'hr_disciplinary_template', $data);
	 ...
	 * @return boolean       
	 */
	public function update_disciplinary_type($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'hr_disciplinary_template', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	{
		$this->db->where('id', $id);
		$this->db->delete(db_prefix() . 'hr_disciplinary_template');
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	 ...
	 * @param array $data 
	 */
	public function add_penalty_type($data)
	{
		$result = $this->db->insert(db_prefix() . 'hr_penalty_template', $data);
		$this->db->last_query($result);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	...
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'hr_penalty_template', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	{
		$this->db->where('id', $id);
		$this->db->delete(db_prefix() . 'hr_penalty_template');
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	public function get_hr_disciplinary_history($id)
	{
		return '';
	}
	 ...
	 * @return [type]      
	 */
	public function get_disciplinary_action_history($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->row();
	...
	public function add_disciplinary_action_history($data)
	{
		$result = $this->db->insert(db_prefix() . 'hr_disciplinary_history_templete', $data);
		$this->db->last_query($result);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	 ...
	 * @return boolean       
	 */
	public function update_disciplinary_action_history($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'hr_disciplinary_history_templete', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	{
		$this->db->where('id', $id);
		$this->db->delete(db_prefix() . 'hr_disciplinary_history_templete');
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	 ...
	 * @return [type]      
	 */
	public function get_action_taken($id = false)
	{

		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'disciplinary_action_taken_type')->row();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'disciplinary_action_taken_type')->result_array();
		}
	}

	/**
	 * add add_disciplinary_history
	 * @param array $data 
	 */

	public function add_disciplinary_history($data)
	{
		$result = $this->db->insert(db_prefix() . 'disciplinary_history', $data);
		$this->db->last_query($result);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}
	 ...
	 * @return [type]      
	 */
	public function get_disciplinary_templetes($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'disciplinary_history')->row();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'disciplinary_history')->result_array();
		}
	}

	public function delete_disciplinary_templetes($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			$this->db->delete(db_prefix() . 'disciplinary_history');
		}
		if ($this->db->affected_rows() > 0) {
			return true;
		}
	...
	public function update_disciplinary_history($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'disciplinary_history', $data);
		return true;
	}

	public function add_issued_assets_benefits($data)
	{
		$result = $this->db->insert(db_prefix() . 'issued_assets_bnefits', $data);
		$this->db->last_query($result);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}

	public function get_issued_assets_benefits($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'issued_assets_bnefits')->row();
		}
		if ($id == false) {
			return  $this->db->get(db_prefix() . 'issued_assets_bnefits')->result_array();
		}
	}


	public function update_issued_assets_benefits($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'issued_assets_bnefits', $data);
		return true;
	}

	public function delete_issued_assets_benefits($id = false)
	{
		if (is_numeric($id)) {
			$this->db->where('id', $id);
			$this->db->delete(db_prefix() . 'issued_assets_bnefits');
		}
		if ($this->db->affected_rows() > 0) {
			return true;
		}
	...
	public function get_disciplinary_remark($id)
	{
		if (is_numeric($id)) {
			$this->db->select('discipline_reason_remarks, company_rules, content_template');
			$this->db->where('id', $id);
			return $this->db->get(db_prefix() . 'hr_disciplinary_history_templete')->row();
		}
		if ($id === false) {
	...
	// get travel
	public function get_required_document_list()
	{
		$travel =	$this->db->get('job_required_document')->result_array();
		if (!empty($travel)) {
			return $travel;
		} else {
			return [];
	...
	public function add_required_document_setting($data)
	{
		$this->db->insert(db_prefix() . 'job_required_document', $data);
		$insert_id = $this->db->insert_id();
		return $insert_id;
	}

	public function update_required_document_setting($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update(db_prefix() . 'job_required_document', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		}
		return false;
	...
	{
		$this->db->where('id', $id);
		$this->db->delete(db_prefix() . 'job_required_document');
		if ($this->db->affected_rows() > 0) {
			return true;
		}
	...
	public function get_required_document_201($id)
	{
		$query = $this->db->select([
			...
			->from(db_prefix() . 'job_required_document as job')
			->join(
				db_prefix() . 'rec_required_document as rec',
				'rec.document_type = job.id AND (rec.staff_id = ' . $this->db->escape($id) . ' OR rec.staff_id IS NULL)',
				'left'
			)
			->get();
	...
	public function get_document_info($staff_id = '', $id = '')
	{
		$query = $this->db->select([
			'job.id',
			'job.document_type',
			...
			->join(
				db_prefix() . 'rec_required_document as rec',
				'rec.document_type = job.id AND (rec.staff_id = ' . $this->db->escape($staff_id) . ' OR rec.staff_id IS NULL)',
				'left'
			);
		if ($id != '' && $id != 0) {
	...
	public function add_update_document_info_cadidate($data)
	{
		...
		$updated = [
			...
			'expiry_date' => to_sql_date($data['expiry_date']),
		...
		if ($id != '') {
			$this->db->where('id', $id);
			$success = $this->db->update(db_prefix() . 'rec_required_document', $updated);
		} else {
			$success = $this->db->insert(db_prefix() . 'rec_required_document', [
				'staff_id' => $staff_id,
	...
	public function get_contract_data($id = false)
	{
		
		if (is_numeric($id)) {
			
			$this->db->where('id_contract', $id);
			return  $this->db->get(db_prefix() . 'hr_staff_contract')->row_array();
		}
	...
	public function update_contract_data($data) {
		$id = $data['id'];
		$updated['content'] = $data['content'];
		echo '<pre>';
		print_r($updated);
		die;
		$updated['contract_templete_select'] = $data['id'];
		$this->db->where('id_contract', $data['contract_id']);
		return $this->db->update(db_prefix() . 'hr_staff_contract', $updated);
	}
}
