...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="checkbox checkbox-primary">
            ...
            <label for="send_to_client"><?php echo _l('email_template_manage_send_to_lead') ?></label>
...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <label class="control-label"><?php echo _l('email_template_manage_webhook_trigger_source_select')?></label>

        <select class="selectpicker" required="required" multiple="multiple" id="status" name="sources[]"
                data-width="100%" data-show-subtext="true" data-live-search="true"
                data-none-selected-text="<?php echo _l('email_template_manage_webhook_trigger_source_select')?>" >
            ...
            foreach ( $sources as $source )
            {
                ...
                $selected = '';
                if( in_array( $source_id , $record_sources ) )
                    $selected = 'selected';

                echo "<option $selected value='$source_id'>$source_text</option>";
            }
...
<div class="col-md-12">
    <hr />
    <p class="text-primary bold"><?php echo _l('email_template_manage_trigger_message')?></p>
</div>
