...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="checkbox checkbox-primary">
            ...
            <label for="send_to_client"><?php echo _l('email_template_manage_send_to_client_or_lead') ?></label>
...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <label class="control-label"><?php echo _l('email_template_manage_proposal_status_select')?></label>
        ...
        <select class="selectpicker" required="required" multiple="multiple" id="status" name="status[]"
                ...
                data-none-selected-text="<?php echo _l('email_template_manage_proposal_status_select')?>" >
            <?php

            foreach ( $status as $statu )
            {

                $status_text    = format_proposal_status( $statu , '', false);
                $statu_id       = $statu;
...
<div class="col-md-6">
    <select class="selectpicker" required="required" id="record_date" name="record_date" data-width="100%" data-show-subtext="true"
        ...
        <option <?php echo $record_date == 'date'       ? 'selected' : '' ?>    value="date"><?php echo _l('proposal_date')?></option>
        <option <?php echo $record_date == 'open_till'  ? 'selected' : '' ?>    value="open_till"><?php echo _l('proposal_open_till') ?></option>
