...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <label class="control-label"><?php echo _l('email_template_manage_project_status_select')?></label>
        ...
        <select class="selectpicker" required="required" multiple="multiple" id="status" name="status[]"
                ...
                data-none-selected-text="<?php echo _l('email_template_manage_project_status_select')?>" >
...
<div class="col-md-6">
    <select class="selectpicker" required="required" id="record_date" name="record_date" data-width="100%" data-show-subtext="true"
        ...
        <option></option>
        <option <?php echo $record_date == 'start_date'      ? 'selected' : '' ?>    value="start_date"><?php echo str_replace( ':' , '' , _l('project_start_date') )?></option>
        <option <?php echo $record_date == 'deadline'        ? 'selected' : '' ?>    value="deadline"><?php echo str_replace( ':' , '' , _l('project_deadline') )?></option>
        <option <?php echo $record_date == 'date_finished'   ? 'selected' : '' ?>    value="date_finished"><?php echo str_replace( ':' , '' , _l('project_completed_date') )?></option>
