...
create_email_template('Spreadsheet Online - Share {type_spreadsheet} Update Notification For You', '<span style=\"font-size: 12pt;\"> Hello {receiver}. </span><br /><br /><span style=\"font-size: 12pt;\">You have been some update notification in the {name_spreadsheet} {type_spreadsheet}</span>
  Please click on the link to view information: {share_link_client_spreadsheet}
  </span><br /><br />', 'spreadsheet_online', 'Spreadsheet update notification to client', 'spreadsheet-update-notification-client');
create_email_template('Spreadsheet Online - Share {type_spreadsheet} Update Notification For You', '<span style=\"font-size: 12pt;\"> Hello {receiver}. </span><br /><br /><span style=\"font-size: 12pt;\">You have been some update notification in the {name_spreadsheet} {type_spreadsheet}</span>
  Please click on the link to view information: {share_link_spreadsheet}
  </span><br /><br />', 'spreadsheet_online', 'Spreadsheet update notification', 'spreadsheet-update-notification');
