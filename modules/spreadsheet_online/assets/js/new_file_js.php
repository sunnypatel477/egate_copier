<script type="text/javascript">
  (function(){
    $("body").on("click", '#luckysheet_info_detail_notification', function() {
          var id = $("input[name=id]").val();
          
          if (id > 0) {
            $.get(site_url + 'spreadsheet_online/Spreadsheet_online_client/send_email_notification/' + id).done(function(response) {
