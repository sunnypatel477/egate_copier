...
class Purchase_orders_model extends App_Model
{
    ...
    public function delete($id, $simpleDelete = false)
    {
        ...
        $delivery_get_ids = get_delivery_qty($id);

        if(isset($delivery_get_ids) && !empty($delivery_get_ids)) {
            set_alert('success', _l('you_can_not_delete_purchase_order_with_delivery_note'));
            return false;
        } 
