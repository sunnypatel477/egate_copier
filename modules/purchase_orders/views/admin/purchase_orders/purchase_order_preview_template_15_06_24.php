                    ...
                    <div class="pull-right _buttons">
                        ...
                        if (isset($purchase_order->delivery_noteid)) {
                            ...
                            foreach ($purchase_order->items as $key => $item) {
                                ...
                                $total_qty = 0;
                                $purchase_qty = get_items_by_type_multiple('purchase_order', $purchase_order->id);
                                $get_delivery_qty = get_items_by_type_delivery('delivery_note',  $delivery_history);

                                $remaining_qty_items[$key] = $purchase_qty[$key]['qty'] - $get_delivery_qty[$key]['total_qty'];
                            }
                        }
                        ?>

                        <?php if (isset($purchase_order->delivery_noteid) && $remaining_qty_items[$key] > 0) { ?>
