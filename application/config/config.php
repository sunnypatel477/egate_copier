...
$config['csrf_exclude_uris'] = ['admin/customemailandsmsnotifications/email_sms/sendEmailSms', 'forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+','instax_printing/Instax_printing_client/update_print_btn_count','instax_printing/Instax_printing_client/send_email','instax_printing/Instax_printing_client/save_image','instax_printing/Instax_printing_client/get_background_by_category'];
