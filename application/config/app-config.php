...
*
*/
define('APP_BASE_URL', 'https://egate.copier.ph/');
...
*/
define('APP_ENC_KEY', '62050958b7d485ed2d0161111c4a6b70');
 ...
 */
define('APP_DB_USERNAME', 'print_egate_copier_erp');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'n~Od]3KQhM7z');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'print_egate_copier_erp');
