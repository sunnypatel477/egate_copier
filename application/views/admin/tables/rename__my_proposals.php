...
return App_table::find('proposals')
    ->outputUsing(function ($params) {
        ...
        foreach ($rResult as $aRow) {
            ...
            $proposal_attachment_copy = $proposaltmpDir . $aRow['proposal_attachment'];
            $proposal_document_copy = $proposaltmpdocumentDir . $aRow['proposal_document'];

            $row[] = render_tags($aRow['tags']);

            $row[] = 'Ref Document: <a href='.$proposal_attachment_copy.' target="_blank">'.$aRow['proposal_attachment'].'</a><br> Attachment: <a href='.$proposal_document_copy.' target="_blank">'.$aRow['proposal_document'].'</a><br>';
