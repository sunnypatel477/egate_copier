...
return App_table::find('estimates')
    ->outputUsing(function ($params) {
        ...
        foreach ($rResult as $aRow) {
            ...
            $estimate_attachment_copy = $estimatetmpDir . $aRow['estimate_attachment'];
            $estimate_document_copy = $estimatetmpdocumentDir . $aRow['estimate_document'];

            $row[] = ''._l('estimate_document').': <a href='.$estimate_document_copy.' target="_blank">'.$aRow['estimate_document'].'</a><br>';
