            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="number" class="form-control" value="<?php echo e($_estimate_number); ?>" data-isedit="<?php echo e($isedit); ?>" data-original-number="<?php echo e($data_original_number); ?>">
                        <?php if ($format == 3) { ?>
                            <span class="input-group-addon">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php echo render_input('estimate_document', 'estimate_document', '', 'file') ?>
                        <?php if (isset($estimate->estimate_document)) { ?>
                            <?php
                            $estimatetmpDir = module_dir_url('client_lead/asset/\estimatedocument');
                            $estimate_document_copy = $estimatetmpDir . $estimate->estimate_document;
                            echo form_hidden('estimate_document_hidden', $estimate->estimate_document); ?>

                            <a href="<?php echo $estimate_document_copy; ?>" target="_blank"><?php echo $estimate->estimate_document; ?></a>
                        <?php } ?>
                    </div>

                    <!-- Attchment -->
                    <div class="col-md-6">
                        <?php //echo render_input('estimate_attachment', 'estimate_attachment', '', 'file') ?>

                        <?php //if (isset($estimate->estimate_attachment)) { ?>
                            <?php
                            // $estimatetmpDir = module_dir_url('client_lead/asset/estimateattachment');
                            // $estimate_attachment_copy = $estimatetmpDir . $estimate->estimate_attachment;
                            // echo form_hidden('estimate_attachment_hidden', $estimate->estimate_attachment); ?>
