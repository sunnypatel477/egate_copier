    ...
    [
            ...
            <div class="tab-content">
                ...
                <div class="row mtop10 mleft10">
                            ...
                            $estimatetmpdocumentDir = module_dir_url('client_lead/asset/estimatedocument');
                            $estimate_attachment_copy = $estimatetmpDir . $estimate->estimate_attachment;
                            $estimate_document_copy = $estimatetmpdocumentDir . $estimate->estimate_document;


                            echo  '<span class="bold tw-text-neutral-700">Document</span>: <a href=' . $estimate_attachment_copy . ' target="_blank">' . $estimate->estimate_attachment . '</a><br> <span class="bold tw-text-neutral-700">Attachment</span>: <a href=' . $estimate_document_copy . ' target="_blank">' . $estimate->estimate_document . '</a><br>';
