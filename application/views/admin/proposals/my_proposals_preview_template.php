                ...
                <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                    ...
                    <?php if (isset($proposal)) { ?>
                        ...
                        <li role="presentation" class="tab-separator">
                            <a href="#tab_tasks" onclick="init_rel_tasks_table(<?php echo e($proposal->id); ?>,'proposal'); return false;" aria-controls="tab_tasks" role="tab" data-toggle="tab">
                                <?php echo _l('tasks'); ?>
                            </a>
                        </li>
                        <li role="presentation" class="tab-separator">
                            <a href="#tab_notes" onclick="get_sales_notes(<?php echo e($proposal->id); ?>,'proposals'); return false" aria-controls="tab_notes" role="tab" data-toggle="tab">
        ...
        <div class="row mtop20">
            ...
            <div class="col-md-9 text-right _buttons proposal_buttons">
                <?php if (staff_can('edit',  'proposals')) { ?>
                    <a href="<?php echo admin_url('proposals/proposal/' . $proposal->id); ?>" data-placement="left" data-toggle="tooltip" title="<?php echo _l('proposal_edit'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa-regular fa-pen-to-square"></i></a>
                <?php } ?>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li class="hidden-xs"><a href="<?php echo admin_url('proposals/pdf/' . $proposal->id . '?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a>
                        </li>
                        ...
                        <li><a href="<?php echo admin_url('proposals/pdf/' . $proposal->id); ?>"><?php echo _l('download'); ?></a>
                        </li>
                        <li>
                ...
                <a href="#" class="btn btn-default btn-with-tooltip" data-target="#proposal_send_to_customer" data-toggle="modal"><span data-toggle="tooltip" class="btn-with-tooltip" data-title="<?php echo _l('proposal_send_to_email'); ?>" data-placement="bottom"><i class="fa-regular fa-envelope"></i></span></a>
                <div class="btn-group ">
                            ...
                            <?php foreach ($proposal_statuses as $status) {
                                if (staff_can('edit',  'proposals')) {
                                    if ($proposal->status != $status) { ?>
                                        <li>
                                            <a href="<?php echo admin_url() . 'proposals/mark_action_status/' . $status . '/' . $proposal->id; ?>"><?php echo e(_l('proposal_mark_as', format_proposal_status($status, '', false))); ?></a>
                                        </li>
                            <?php
                                    }
                                }
            ...
            <div class="col-md-12">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                        <div class="row mtop10">
                            ...
                            <div class="col-md-6">
                                ...
                                <h5 class="bold mbot15 font-medium"><a href="<?php echo admin_url('proposals/proposal/' . $proposal->id); ?>"><?php echo e($proposal->subject); ?></a>
                                </h5>
                            ...
                            <div class="col-md-6 text-right">
                                <address class="tw-text-neutral-500">
                                    <span class="bold tw-text-neutral-700"><?php echo _l('proposal_to'); ?>:</span><br />
                            ...
                            <?php foreach ($proposal->attachments as $attachment) {
                                ...
                                <div class="mbot15 row" data-attachment-id="<?php echo e($attachment['id']); ?>">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a href="#" data-toggle="tooltip" onclick="toggle_file_visibility(<?php echo e($attachment['id']); ?>,<?php echo e($proposal->id); ?>,this); return false;" data-title="<?php echo e($tooltip); ?>"><i class="fa <?php echo e($icon); ?>" aria-hidden="true"></i></a>
                                        <?php if ($attachment['staffid'] == get_staff_user_id() || is_admin()) { ?>
                                            <a href="#" class="text-danger" onclick="delete_proposal_attachment(<?php echo e($attachment['id']); ?>); return false;"><i class="fa fa-times"></i></a>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php
                        ...
                        <?php if (isset($proposal_merge_fields)) { ?>
                            <p class="bold text-right"><a href="#" onclick="slideToggle('.avilable_merge_fields'); return false;"><?php echo _l('available_merge_fields'); ?></a>
                            </p>
                            <hr class="hr-panel-separator" />
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_attachment">
                        <div class="row mtop10 mleft10">
                            <?php
                            $proposaltmpDir = module_dir_url('client_lead/asset/proposalattachment');
                            $proposaltmpdocumentDir = module_dir_url('client_lead/asset/proposaldocument');
                            $proposal_attachment_copy = $proposaltmpDir . $proposal->proposal_attachment;
                            $proposal_document_copy = $proposaltmpdocumentDir . $proposal->proposal_document;


                            // echo  '<span class="bold tw-text-neutral-700">'._l('proposal_document').'</span>: <a href=' . $proposal_attachment_copy . ' target="_blank">' . $proposal->proposal_attachment . '</a><br> <span class="bold tw-text-neutral-700">'._l('attachment').'</span>: <a href=' . $proposal_document_copy . ' target="_blank">' . $proposal->proposal_document . '</a><br>';

                            echo  '<span class="bold tw-text-neutral-700">'._l('proposal_document').'</span>: <a href=' . $proposal_document_copy . ' target="_blank">' . $proposal->proposal_document . '</a><br>';
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_templates">
                        <div class="row proposal-templates">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary" onclick="add_template('proposals',<?php echo $proposal->id ?? '' ?>);">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_reminders">
                        <a href="#" data-toggle="modal" class="btn btn-primary" data-target=".reminder-modal-proposal-<?php echo e($proposal->id); ?>"><i class="fa-regular fa-bell"></i> <?php echo _l('proposal_set_reminder_title'); ?></a>
                        <hr />
