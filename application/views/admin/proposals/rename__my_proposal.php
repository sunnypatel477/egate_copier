...
<div id="wrapper">
    <div class="content accounting-template proposal">
        <div class="row">
            ...
            $uri_string = $this->uri->uri_string(); // Assume this returns 'admin/proposals/proposal/1'
            $segments = explode('/', $uri_string);
            $segment_id = end($segments);
            ...
            echo form_open_multipart(admin_url('client_lead/leads/proposal/' . $id), ['id' => 'proposal-form', 'class' => '_transaction_form proposal-form']);
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 border-right">
                                ...
                                <!-- Document -->
                                <div class="mtop20">
                                    <?php echo render_input('proposal_document', 'proposal_document', '', 'file') ?>

                                    <?php if (isset($proposal->proposal_document)) { ?>

                                        <?php
                                        $proposaltmpDir = module_dir_url('client_lead/asset/\proposaldocument');
                                        $proposal_document_copy = $proposaltmpDir . $proposal->proposal_document;
                                        echo form_hidden('proposal_document_hidden', $proposal->proposal_document); ?>

                                        <a href="<?php echo $proposal_document_copy; ?>" target="_blank"><?php echo $proposal->proposal_document; ?></a>
                                ...
                                <!-- Attchment -->
                                <!-- <div class="mtop20">
                                    <?php //echo render_input('proposal_attachment', 'proposal_attachment', '', 'file') ?>

                                    <?php // if (isset($proposal->proposal_attachment)) { ?>
                                        <?php
                                        ...
                                        // echo form_hidden('proposal_attachment_hidden', $proposal->proposal_attachment); ?>

                                        <a href="<?php //echo $proposal_attachment_copy; ?>" target="_blank"><?php //echo $proposal->proposal_attachment; ?></a>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group select-placeholder">
                                            ...
                                            ?>
                                            <select name="status" class="selectpicker" data-width="100%" <?php echo e($disabled); ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                        ...
                        <div class="btn-bottom-toolbar bottom-transaction text-right sm:tw-flex sm:tw-items-center sm:tw-justify-between">
                            ...
                            <div>
                                <button type="button" class="btn btn-default mleft10 proposal-form-submit save-and-send transaction-submit">
