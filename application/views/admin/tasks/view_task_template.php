...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <h4 style="color:#FF0000;" class="th tw-font-semibold tw-text-base mbot15 pull-left"><?php echo _l('task_view_description'); ?>
        </h4>
        ...
        <div class="clearfix"></div>
        <hr />
        <a style="text-align: right;width: 100%;" href="#" onclick="add_task_checklist_item('<?php echo e($task->id); ?>', undefined, this); return false"
        ...
        <div class="row task_attachments_wrapper">
            <div class="col-md-12" id="attachments">
                <hr />
                <h4 style="color:#FF0000;" class="th tw-font-semibold  tw-text-base mbot15"><?php echo _l('task_view_attachments'); ?></h4>
                <div class="row">
                    <?php
                     $i = 1;
        ...
        <a href="#" id="taskCommentSlide" onclick="slideToggle('.tasks-comments'); return false;">
            <h4 style="color:#FF0000;" class="mbot20 font-medium"><?php echo _l('task_comments'); ?></h4>
        </a>
