...
function init_relation_tasks_table($table_attributes = [], $filtersWrapperId = 'vueApp')
{
    ...
    if ($table_attributes['data-new-rel-type'] == 'project') {
        ...
        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="invoice" id="ts_rel_to_invoice" name="tasks_related_to[]">
        <label for="ts_rel_to_invoice">' . _l('invoices') . '</label>
        </div>

        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="estimate" id="ts_rel_to_estimate" name="tasks_related_to[]">
        <label for="ts_rel_to_estimate">' . _l('estimates') . '</label>
        </div>

        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="contract" id="ts_rel_to_contract" name="tasks_related_to[]">
        <label for="ts_rel_to_contract">' . _l('contracts') . '</label>
        </div>

        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="ticket" id="ts_rel_to_ticket" name="tasks_related_to[]">
        <label for="ts_rel_to_ticket">' . _l('tickets') . '</label>
        </div>

        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="expense" id="ts_rel_to_expense" name="tasks_related_to[]">
        <label for="ts_rel_to_expense">' . _l('expenses') . '</label>
        </div>

        <div class="checkbox checkbox-inline">
        <input type="checkbox" checked value="proposal" id="ts_rel_to_proposal" name="tasks_related_to[]">
