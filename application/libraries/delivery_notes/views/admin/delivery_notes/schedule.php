    ...
    <div class="panel_s">
        <div class="panel-body">
            <h4 class="tw-my-0 tw-font-semibold">
                <?php echo _l('schedule_email_for', format_delivery_note_number($delivery_note->id)); ?>
            </h4>
        ...
        <div class="panel-footer text-right">
            <a href="#" class="btn btn-danger" onclick="init_delivery_note(<?php echo $delivery_note->id; ?>); return false;">
                <?php echo _l('cancel'); ?>
            </a>
